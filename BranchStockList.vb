...
Public Class BranchStockList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DMHStockMaster.BranchStockList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_WeekEnding() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedBranchStockList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BranchStockList = New BranchStockList()
        rpt.Site = Me.Site
        Return rpt
    End Function
